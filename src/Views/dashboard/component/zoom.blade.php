...
<div class="col-lg-8 col-md-12 col-12">
  <div class="form-add">
    ...
    <input type="text" name="account_id" id="account_id"
      value="{{ isset($live_account) ? $live_account->account_id : old('account_id') }}"
...
<div class="col-lg-8 col-md-12 col-12">
  <div class="form-add">
    <label for="sdk_key">SDK Key</label>
    <input type="text" name="sdk_key" id="sdk_key"
      value="{{ isset($live_account) ? $live_account->sdk_key : old('sdk_key') }}" placeholder="Enter SDK Key" />
  </div>
  @error('sdk_key')
    <span class="text-danger">{{ $message }}</span>
  @enderror
...
<div class="col-lg-8 col-md-12 col-12">
  <div class="form-add">
    <label for="sdk_secret">SDK Secret</label>
    <input type="text" name="sdk_secret" id="sdk_secret"
      value="{{ isset($live_account) ? $live_account->sdk_secret : old('sdk_secret') }}"
